        ...
        <div className='mx-6'>
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-green-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-green-300 text-green-600 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-green-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>AMARABA</span> UDS First Centralised Online MarketPlace <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                ...
                <div className='flex flex-col md:flex-row xl:flex-col gap-5 w-full xl:max-w-sm text-sm text-slate-600'>
                    <div className='flex-1 flex items-center justify-between w-full bg-[#2dc653] rounded-3xl p-6 px-8 group'>
                        <div>
                    ...
                    <div className='flex-1 flex items-center justify-between w-full bg-[#6ede8a] rounded-3xl p-6 px-8 group'>
                        <div>
